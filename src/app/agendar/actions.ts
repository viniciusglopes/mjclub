...
export async function bookAppointment(formData: FormData) {
  ...
  const back = (message: string, params: URLSearchParams) => {
  ...
  redirect(`/agendar/confirmado/${appointmentId}`);
}
